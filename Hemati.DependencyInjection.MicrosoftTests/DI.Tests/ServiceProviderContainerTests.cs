...
using Xunit;
using DependencyInjectionSpecificationTests = Microsoft.Extensions.DependencyInjection.Specification.DependencyInjectionSpecificationTests;
...
namespace Microsoft.Extensions.DependencyInjection.Tests
{
    public abstract class ServiceProviderContainerTests : DependencyInjectionSpecificationTests
    {
        ...
        [Fact(Skip = "Expects specific exception, not changing that")]
        ...
        [Fact(Skip = "Weird specific behaviour")]
        ...
        [Theory(Skip = "Assumes there is validation at CreateServiceProvider")]
        ...
        [Theory(Skip = "Too specific to fix")]
        ...
        [Fact(Skip = "Idk, I expext singleton to be disposed...")]
        ...
        [Fact(Skip = "Assumes that if stack exceeds, it calls resolve on separate thread => too compicated to implement without much benifit for now")]
        ...
        [Fact(Skip = "Assumes IAsyncDisposable")]
        ...
        [Fact(Skip = "For now, not supporting dispose of transient services")]
        ...
        [Fact(Skip = "We consider that not an error")]
        ...
        [Fact(Skip = "Difference in implementation")]
